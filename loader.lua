-- Pistol Arena v4.4 | plalettescripts
        ...
        if p ~= LocalPlayer and p.Character then
            ...
            if head then
                ...
                if onScreen then
                    ...
                    if dist < Config.AimRadius and dist < best then
                        best = dist
                        target = p
                    end
                end
...
PassFrame.Size = UDim2.new(0, 240, 0, 140)
PassFrame.Position = UDim2.new(0.5, -120, 0.5, -70)
...
PassTitle.Text = "Pistol Arena v4.4"
...
PassInput.Size = UDim2.new(1, -30, 0, 28)
PassInput.Position = UDim2.new(0, 15, 0, 60)
...
PassBtn.Size = UDim2.new(1, -30, 0, 26)
PassBtn.Position = UDim2.new(0, 15, 0, 95)
...
PassInput.FocusLost:Connect(function(ep)
    if ep then
        TryPass()
    end
end)
...
function LoadMain()
    ...
    MiniText.Text = "v4.4 | plalettescripts | CTRL"
    ...
    HeaderTitle.Text = "Pistol Arena v4.4"
    ...
    local function CreateTab(name, icon)
        ...
        btn.MouseButton1Click:Connect(function()
            ...
            for _, p in pairs(tabContents) do
                p.Visible = false
            end
    ...
    local function Section(page, text)
        ...
        l.Parent = f
        local y = page.CanvasSize.Y.Offset
        page.CanvasSize = UDim2.new(0, 0, 0, y + 22)
    end
    ...
    local function Toggle(page, name, key)
        ...
        tb.MouseButton1Click:Connect(function()
            ...
            if on then
                TweenService:Create(track, TweenInfo.new(0.2), {
                    BackgroundColor3 = Color3.fromRGB(91, 81, 244)
                }):Play()
        ...
        local y = page.CanvasSize.Y.Offset
        page.CanvasSize = UDim2.new(0, 0, 0, y + 34)
    end
    ...
    local function Slider(page, name, key, min, max, def)
        ...
        local y = page.CanvasSize.Y.Offset
        page.CanvasSize = UDim2.new(0, 0, 0, y + 48)
    end
                ...
                for _, p in ipairs(Players:GetPlayers()) do
                    if p ~= LocalPlayer and p.Character then
                        ...
                        if head and hrp then
                            local hp, on = Camera:WorldToViewportPoint(
                                head.Position + Vector3.new(0, 0.5, 0)
                            )
                            local fp = Camera:WorldToViewportPoint(
                            ...
                            if pl.Character then
                                ...
                                if th then
                                    ...
                                    if pl == LocalPlayer then
                                        dt.Color = Color3.fromRGB(0, 255, 0)
                                    else
                                        dt.Color = Color3.fromRGB(91, 81, 244)
                                    end
                                    dt.Radius = 2
    ...
    RunService.Stepped:Connect(function()
        ...
        if Config.SpeedHack and LocalPlayer.Character then
            local h = LocalPlayer.Character:FindFirstChildOfClass("Humanoid")
            if h then
                h.WalkSpeed = math.min(Config.SpeedValue, 28)
            end
        end
    ...
    UserInputService.JumpRequest:Connect(function()
        if Config.InfJump and ScriptActive and LocalPlayer.Character then
            local h = LocalPlayer.Character:FindFirstChildOfClass("Humanoid")
            if h then
            ...
            if Config.Fly and LocalPlayer.Character then
                ...
                if hrp then
                    ...
                    if UserInputService:IsKeyDown(Enum.KeyCode.W) then
                        m = m + Camera.CFrame.LookVector
                    end
                    if UserInputService:IsKeyDown(Enum.KeyCode.S) then
                        m = m - Camera.CFrame.LookVector
                    end
                    if UserInputService:IsKeyDown(Enum.KeyCode.A) then
                        m = m - Camera.CFrame.RightVector
                    end
    ...
    -- Fullbright + Anti-AFK
    task.spawn(function()
        while task.wait(60) and ScriptActive do
    ...
    print("Pistol Arena v4.4 loaded | plalettescripts")
end
